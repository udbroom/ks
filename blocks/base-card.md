...
- The media's zoom-on-hover effect only appears when the card actually contains a link (standalone link or button) — a card authored with no link at all no longer zooms on hover, since there's nothing to click.[^hover-link-only]
...
[^hover-link-only]: [#6537](https://github.com/adobecom/milo/pull/6537) — Narcis Radu, 2026-08-24
